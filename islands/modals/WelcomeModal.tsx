...
const features = [
  {
    ...
    description: "Effortlessly organize and prioritize your tasks with our user-friendly interface",
    icon: "📋"
  },
  {
    title: "Seamless GitHub Integration",
    description: "Create, track, and manage GitHub issues without leaving the app",
    icon: "🔄"
  },
  {
    title: "Time Tracking & Analytics",
    description: "Monitor project progress and optimize productivity with built-in time tracking",
    icon: "⏱️"
  },
  {
    title: "Continuous Improvement",
    description: "We're constantly adding new features based on user feedback - your ideas shape our future!",
    icon: "🚀"
  },
];
