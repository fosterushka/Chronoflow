          ...
          <div class="mt-2 flex gap-2">
            <div class="flex-1">
              <input
                  ...
                  class={`w-full px-2 py-1 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white ${meetingUrlError ? "border-red-500" : "border-gray-200 dark:border-gray-600"}`}
              />
              {meetingUrlError && (
            ...
            <div class="flex gap-2">
              <div class="flex-1">
                <input
                    ...
                    class={`w-full px-2 py-1 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white ${relatedUrlError ? "border-red-500" : "border-gray-200 dark:border-gray-600"}`}
                />
                {relatedUrlError && (
