  ...
  return (
    ...
    >
      <div class="p-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700">
        <div class={`flex items-center gap-3 ${isCollapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'} transition-all overflow-hidden`}>
          ...
          <h1 class="font-bold text-gray-900 dark:text-white whitespace-nowrap">Chronoflow</h1>
        </div>
      ...
      >
        <svg 
          class={`w-4 h-4 text-gray-400 transition-transform duration-300 ${isCollapsed ? 'rotate-180' : ''}`} 
          fill="none" 
          stroke="currentColor" 
          viewBox="0 0 24 24"
        >
      ...
      <div class={`flex-1 overflow-y-auto ${isCollapsed ? 'opacity-0 invisible' : 'opacity-100 visible'} transition-all duration-300`}>
        ...
        <div class="flex-1 py-4">
          <div class="space-y-4">
            ...
            <div class="px-4 group relative">
              ...
              <div class="absolute left-full ml-2 px-2 py-1 bg-gray-900/90 text-white text-xs rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all whitespace-nowrap z-50">
                Time Spent: {Math.floor(stats.totalTimeSpent / 3600)}h {Math.floor((stats.totalTimeSpent % 3600) / 60)}m
              </div>
            </div>
          </div>
        </div>
